<?php
  ...
  $sql = "UPDATE catalog SET item_name = '$item_name', item_price = '$item_price', item_quantity = '$item_quantity', item_desc = '$item_desc' WHERE item_id = '$item_id'";
